...
# Windows consoles default to cp1252, which can't encode the 📄 emoji (or any
# non-ASCII paper title/author). Reconfigure stdout to UTF-8 so print() works
# unchanged everywhere; on platforms where this is a no-op, behavior is identical.
